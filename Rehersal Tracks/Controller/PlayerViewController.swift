...
class PlayerViewController: UIViewController {
    ...
    @IBAction func returnToSongsButtonPressed(_ sender: UIButton) {
        let storyboard = UIStoryboard(name: "Main", bundle: nil)
        let rockGenresTV = storyboard.instantiateViewController(withIdentifier: "RockGenresTV") as! RockGenreTableViewController
        let appDelegate = UIApplication.shared.delegate as! AppDelegate
        appDelegate.window?.rootViewController = rockGenresTV
    ...
    func setupAudioPlayer() {
        ...
        guard let audioFileURL = Bundle.main.url(forResource: "practrack", withExtension: "mp3") else { return }
